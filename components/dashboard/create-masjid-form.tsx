...
import { AlertDialogDescription, AlertDialogFooter, AlertDialogTitle } from "../ui/alert-dialog"
...
export function CreateMasjidForm({ isOpen, onClose, onSuccess }: CreateMasjidFormProps) {
  ...
  return (
    <div className="sm:max-w-[600px] p-0 border-0 rounded-lg overflow-hidden">
