  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-xl text-[#3A3A3A] mb-8 max-w-lg">
              Mizan brings together prayer times, donations, digital displays, and websites in one powerful platform for
              modern masjids.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/dashboard">
                <Button size="lg" className="bg-[#550C18] hover:bg-[#78001A] text-white text-lg px-8">
                  Start Free Trial
                </Button>
              </Link>
              <Link href="#demo">
            ...
            <div className="absolute inset-0 z-20 flex items-center justify-center">
              <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-lg max-w-md">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-[#550C18] my-0">Mizan Dashboard</h3>
                </div>
                <div className="grid grid-cols-2 gap-3 mb-4">
                  <div className="bg-white p-3 rounded-lg border border-[#550C18]/10">
                    <p className="text-sm font-medium text-[#3A3A3A] m-0">Prayer Times</p>
                    <p className="text-2xl font-bold text-[#550C18] m-0">5</p>
                  </div>
                  <div className="bg-white p-3 rounded-lg border border-[#550C18]/10">
                    <p className="text-sm font-medium text-[#3A3A3A] m-0">Donations</p>
                    <p className="text-2xl font-bold text-[#550C18] m-0">$12.5k</p>
                  </div>
                  <div className="bg-white p-3 rounded-lg border border-[#550C18]/10">
                    <p className="text-sm font-medium text-[#3A3A3A] m-0">Events</p>
                    <p className="text-2xl font-bold text-[#550C18] m-0">8</p>
                  </div>
                  <div className="bg-white p-3 rounded-lg border border-[#550C18]/10">
                    <p className="text-sm font-medium text-[#3A3A3A] m-0">Users</p>
      ...
      <section id="features" className="py-16 md:py-24 bg-[#550C18]/5">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-[#550C18] mb-4 my-6">All-in-One Masjid Management</h2>
      ...
      <section id="products" className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-[#550C18] mb-4 my-6">Our Products</h2>
            <p className="text-xl text-[#3A3A3A] max-w-2xl mx-auto">
          ...
          <div className="mt-16 text-center">
            <h3 className="text-2xl font-bold text-[#550C18] mb-6 my-4">Need the complete solution?</h3>
            <Link href="#contact">
              <Button size="lg" className="bg-[#550C18] hover:bg-[#78001A] text-white text-lg px-8">
      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-[#550C18] to-[#78001A] text-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 my-6">Trusted by Masjids Worldwide</h2>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-[#3A3A3A] mb-8">
              Join hundreds of masjids already using Mizan to streamline operations and engage their communities.
            </p>
  ...
  return (
    <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow">
      <div className="h-16 w-16 rounded-full bg-[#550C18]/10 flex items-center justify-center mb-4">
        <Image src={icon || "/placeholder.svg"} alt={title} width={40} height={40} className="text-[#550C18]" />
      </div>
      <h3 className="text-xl font-semibold text-[#550C18] mb-2 my-2">{title}</h3>
  ...
  return (
    ...
    >
      ...
      <div className="bg-white p-6">
        ...
        <Button
          className={`w-full ${featured ? "bg-[#550C18] hover:bg-[#78001A] text-white" : "bg-[#550C18]/10 hover:bg-[#550C18]/20 text-[#550C18]"}`}
        >
          Get Started
