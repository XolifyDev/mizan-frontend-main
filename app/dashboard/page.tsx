  ...
  return (
    <SidebarProvider>
      <div className="flex min-h-screen bg-white w-full">
        ...
        <Sidebar className="sticky top-0 z-10 border-r border-[#550C18]/10 bg-white/80 backdrop-blur-md">
          <SidebarHeader className="border-b border-[#550C18]/10 px-6 py-4 !m-0">
            <div className="flex items-center justify-center gap-2 !m-0">
              <Image src="mizan.svg" width={30} height={30} alt="Mizan Logo" />
              <h1
        ...
        <div className="relative z-10 flex-1 h-min bg-white">
          <header className="border-b border-[#550C18]/10 bg-white p-4 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-2xl font-semibold text-[#550C18] !m-0">
                Dashboard
              </h1>
            </div>
